...
void PointCloudProcessor::cloud_callback(const sensor_msgs::msg::PointCloud2::ConstSharedPtr recent_cloud)
{
    ...
    try {
        //RCLCPP_INFO(get_logger(), "sup dog");
    ...
    /* ========================================
     * LINUS PASSTHROUGH FILTERING
     * ========================================*/
     /*
    
      pcl::PointCloud<pcl::PointXYZ> passth;
      pcl::PassThrough<pcl::PointXYZ> pass;
      pass.setInputCloud(passth);
      pass.setFilterFieldName("x"); // Or "y", "z"
      pass.setFilterLimits(1, 2); // Replace with your desired values
      ...
      //publisher.publish(filtered_cloud_msg);
    ...
    *cloud_filtered = *cloud_f;
    ...
    //this->publishPointCloud(passthrough_pub_, *passth); 
